          ...
          <TableBody>
            {products && products.map((currentproduct) => (
              <StyledTableRow key={currentproduct._id}>
                ...
                <StyledTableCell align="right">
                  <Link className={classes.linkChange} to={`/edit/${currentproduct._id}`}>Modifier</Link>
                  {' '}
                  |
                  {' '}
                  <a href="/#" className={classes.linkChange} onClick={() => { deleteProducts(currentproduct._id); }}>Supprimer</a>
                </StyledTableCell>
              </StyledTableRow>
            ))}
          </TableBody>
